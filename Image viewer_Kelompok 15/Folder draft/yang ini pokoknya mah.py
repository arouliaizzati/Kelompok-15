...
def cari_gambar(dll):
    ...
    print(Fore.WHITE + "  1. Cari berdasarkan ID")
    print("  2. Cari berdasarkan Nama File" + Style.RESET_ALL)
...
def main():
    ...
    while True:
        ...
        judul("SELAMAT DATANG DI IMAGE REVIEWER", Fore.CYAN)
        judul("Sistem Pengelolaan & Viewer Gambar", Fore.YELLOW)
        panel([
            "1. Lihat List Gambar",
            "2. Tambah Gambar",
            "3. Update Gambar",
